...
// CFG_ENV_ADDR
#if defined (SPI_FLASH_CONFIG_OFFSET)
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + SPI_FLASH_CONFIG_OFFSET)
#else
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE)
#endif
// CFG_FACTORY_OFFSET
#if defined(SPI_FLASH_FACTORY_OFFSET)
#define CFG_FACTORY_OFFSET	(SPI_FLASH_FACTORY_OFFSET)
#else
#define CFG_FACTORY_OFFSET	(CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE)
#endif
// CFG_KERNEL_OFFSET
#if defined(SPI_FLASH_FIRMWARE_OFFSET)
#define CFG_KERNEL_OFFSET	(SPI_FLASH_FIRMWARE_OFFSET)
#else
#define CFG_KERNEL_OFFSET	(CFG_BOOTLOADER_SIZE + CFG_FACTORY_SIZE + CFG_CONFIG_SIZE)
#endif
//define absolute address for the factory, kernel
#define CFG_FACTORY_ADDR	(CFG_FLASH_BASE + CFG_FACTORY_OFFSET)
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + CFG_KERNEL_OFFSET)
#ifdef DUAL_IMAGE_SUPPORT
#define CFG_KERN2_ADDR		(CFG_FLASH2_BASE + CFG_KERNEL_OFFSET)
#endif
#endif
#endif
...
#if defined(SPI_FLASH_FIRMWARE_SIZE)
#define CFG_KERN_SIZE		(SPI_FLASH_FIRMWARE_SIZE)
#else
#define CFG_KERN_SIZE		(CFG_SPI_FLASH_SIZE - (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE))
#endif
...
#if defined(CFG_KERN2_SIZE)
#define WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES	(CFG_SPI_FLASH_SIZE - (CFG_KERN_SIZE + CFG_KERN2_SIZE))
#else
#define WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES	(CFG_SPI_FLASH_SIZE - CFG_KERN_SIZE)
#endif
