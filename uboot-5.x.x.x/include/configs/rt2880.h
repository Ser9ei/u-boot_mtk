...
#define CONFIG_ETHADDR "28:D1:27:EA:4F:47"
...
//define SPI Flash size
#if defined (ON_BOARD_2M_FLASH_COMPONENT)
#define CFG_SPI_FLASH_SIZE	0x200000
#elif defined (ON_BOARD_4M_FLASH_COMPONENT)
#define CFG_SPI_FLASH_SIZE	0x400000
#elif defined (ON_BOARD_8M_FLASH_COMPONENT)
#define CFG_SPI_FLASH_SIZE	0x800000
#elif defined (ON_BOARD_16M_FLASH_COMPONENT)
#define CFG_SPI_FLASH_SIZE	0x1000000
#elif defined (ON_BOARD_32M_FLASH_COMPONENT)
#define CFG_SPI_FLASH_SIZE	0x2000000
#endif
...
#endif
//CFG_ENV_ADDR
#if defined (SPI_FLASH_CONFIG_OFFSET_LAST)
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + (CFG_SPI_FLASH_SIZE - CFG_CONFIG_SIZE))
#else
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + CFG_BOOTLOADER_SIZE)
#endif
//define CFG_FACTORY_OFFSET
#if defined (SPI_FLASH_FACTORY_OFFSET_40000)
#define CFG_FACTORY_OFFSET      0x40000
#elif  defined (SPI_FLASH_FACTORY_OFFSET_30000)
#define CFG_FACTORY_OFFSET      0x30000
#elif  defined (SPI_FLASH_FACTORY_OFFSET_20000)
#define CFG_FACTORY_OFFSET      0x20000
#elif  defined (SPI_FLASH_FACTORY_OFFSET_10000)
#define CFG_FACTORY_OFFSET      0x10000
#else
#define CFG_FACTORY_OFFSET      0x00000
#endif
//define 
#if defined (SPI_FLASH_OTHERS_OFFSET_AFTER_FIRMWARE)
#define CFG_KERNEL_OFFSET	0x00000
#else
#define CFG_KERNEL_OFFSET	CFG_OFFSET_SIZE
#endif
//define absolute address for the factory, kernel
#if defined (SPI_FLASH_CONFIG_OFFSET_LAST)
#define CFG_FACTORY_ADDR	(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_FACTORY_OFFSET))
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_FACTORY_SIZE + CFG_KERNEL_OFFSET))
#ifdef DUAL_IMAGE_SUPPORT
#define CFG_KERN2_ADDR		(CFG_FLASH2_BASE + (CFG_BOOTLOADER_SIZE + CFG_FACTORY_SIZE + CFG_KERNEL_OFFSET))
#endif
#else
#define CFG_FACTORY_ADDR	(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_OFFSET))
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE + CFG_KERNEL_OFFSET))
#ifdef DUAL_IMAGE_SUPPORT
#define CFG_KERN2_ADDR		(CFG_FLASH2_BASE + (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE + CFG_KERNEL_OFFSET))
#endif
#endif
#endif
...
#define CFG_KERN_SIZE		(CFG_SPI_FLASH_SIZE - (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE + CFG_OFFSET_SIZE))
...
#define WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES	(CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE + CFG_OFFSET_SIZE)
...
_WEBFAILSAFE_UPLOAD_FACTORY_ADDRESS WEBFAILSAFE_UPLOAD_FACTORY_ADDRESS
_WEBFAILSAFE_UPLOAD_FACTORY_SIZE_IN_BYTES WEBFAILSAFE_UPLOAD_FACTORY_SIZE_IN_BYTES
_WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES
_CFG_OFFSET_SIZE CFG_OFFSET_SIZE
_CFG_KERN_SIZE CFG_KERN_SIZE
_SPI_FLASH_OTHERS_OFFSET_AFTER_FIRMWARE SPI_FLASH_OTHERS_OFFSET_AFTER_FIRMWARE
_SPI_FLASH_OTHERS_OFFSET_BEFORE_FIRMWARE SPI_FLASH_OTHERS_OFFSET_BEFORE_FIRMWARE
*/
/*-----------------------------------------------------------------------
 * Cache Configuration
 */
